...
// RecordItem scans one row from the medical record list flow.
func RecordItem(row pgx.Row) (domain.MedicalRecordItem, error) {
...
// Record scans one full medical record row before children are attached.
func Record(row pgx.Row) (domain.MedicalRecord, error) {
