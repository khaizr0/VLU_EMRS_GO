...
// NewHandler wires hematology service into HTTP handlers.
func NewHandler(service *Service) *Handler {
	return &Handler{service: service}
}

// Create handles POST /medical-records/:recordId/clinicals/hematologies.
...
// ChangeStatus handles PUT /medical-records/:recordId/clinicals/hematologies/:id.
...
// Complete handles PUT /medical-records/:recordId/clinicals/hematologies/:id/complete.
...
// Delete handles DELETE /medical-records/:recordId/clinicals/hematologies/:id.
